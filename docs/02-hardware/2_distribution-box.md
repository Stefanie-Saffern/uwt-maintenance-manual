...
<div style="width: 300px;">
![Transceiver cables connection](https://raw.githubusercontent.com/stefanie-saffern/uwt-maintenance-manual/main/images/hardware/transceiver-cables-connection.png)
</div>
...
As stated above, there are two stepdown transformers in the distribution box, one for the LF transmit signal and one for the HF transmit signal. The LF transmit signal transformer reduces the TX signal level from 220 Vrms (the power amplifier output) to 110 Vrms, 
